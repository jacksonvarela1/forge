const DAYMETA = {
  mon:{abbr:'MON',title:'Kicks & Hips',type:'technical',intensity:3,warm:'hips',cool:'hips',lift:'Lift: Upper A + forearms. Primer was pogos, approach runs and neck.',focus:'The only leg-skill day of the week. Ladder into it, do not open at full height.',flag:'Two days after Saturday\u2019s squat and the legs are still coming back, and this morning\u2019s pogos already taxed the calves. Low kicks, then body, then head, and if a head kick is on today\u2019s list leave it until last. The base foot is the limiter today, not the kicking leg.'},
  tue:{abbr:'TUE',title:'Combinations',type:'technical',intensity:3,warm:'upperk',cool:'upper',lift:'No lift today. This is one of only two low days you get.',focus:'Chain it clean at 60 to 70 percent. Hands lead, the legs just carry you.',flag:'Tomorrow morning is the jump block, the most protected 20 minutes of your week. Hands-led is what keeps this cheap: no fight-pace finishes, no sprint rounds, nothing that leaves your legs heavy. Walk away with air left.'},
  wed:{abbr:'WED',title:'Boxing',type:'technical',intensity:2,warm:'upper',cool:'upper',lift:'Lift: jump block first, then Lower Hamstring + abs.',focus:'Hands and angles. The richest technical session of the week, and physically a coast.',flag:'You already jumped and hinged this morning, so nothing tonight can hurt the jump block. But the feet step and pivot today, they never bounce: nothing that loads the legs, no rope, no skipping, no bounding. Calves and Achilles are full from the pogos.'},
  thu:{abbr:'THU',title:'Output & Core',type:'hard',intensity:5,warm:'full',cool:'full',lift:'No lift today. The only clean hard day in the week.',focus:'The one session where you chase pace. Hands, trunk, breathing.',flag:'24 hours after RDLs and Nordics, which is when hamstring soreness peaks. Output comes from hand speed and breathing here, never from ground contacts. Sore is expected. Sharp or pulling is not, and it ends the round.'},
  fri:{abbr:'FRI',title:'Defense & Counters',type:'technical',intensity:2,warm:'upperk',cool:'upper',lift:'Lift: Upper B + forearms, including the landmine rotation.',focus:'Read and punish. Sharp hands, quiet legs.',flag:'Tomorrow is the overreach day: trap bar jumps and a heavy squat. Keep the legs out of tonight. Checks and pivots yes, kick volume no. The landmine rotation you did this morning is the same chain as the check hook, so go spend it.'},
  sat:{abbr:'SAT',title:'Hands & Core',type:'hard',intensity:5,warm:'upper',cool:'upper',lift:'Lift: Lower Quad + abs. Trap bar jumps, squat, Bulgarians, bounds.',focus:'Hands only. The hard part of today already happened this morning.',flag:'Day six of seven and the biggest total load of the week. Six hours after the lift if you can, four minimum. One core station only, the lift already gave you two. Flat feet, short steps, no bounding, you bounded this morning. Finishing five minutes early today is a win, not a miss.'},
  sun:{abbr:'SUN',title:'Restore',type:'recovery',intensity:1,warm:null,cool:null,lift:'No lift today.',focus:'Form, mobility, film. No power, no pace, no exceptions.',flag:'This day exists to make Monday\u2019s kicks and Wednesday\u2019s jump block possible. Spend the mobility on ankles and hip flexors first, they cap your kick pivot and your jump approach both. Hamstrings long and easy only, you are 24 hours off a heavy squat.'}
};
...
/* ================= WEEK 5 ================= */
{n:5,phase:'Phase 3 · Reaction',theme:'Counters',note:'Stop initiating everything. Read, react, punish. Second week on the bag, so the drills go live: run every Rounds block on it, wraps and gloves every time, kicks at 60 to 70 percent while the shins keep adapting. NO BAG YET: shadow every Rounds block and treat the bag weeks as postponed, not skipped.',
 d:{
  mon:{tm:{work:180,rest:60,rounds:3},
...
{n:7,phase:'Phase 4 · Power',theme:'Heavy Hands',note:'First full bag phase. Power is a skill air cannot teach: ground force through rotation into a real object. Sit down on every shot, kick through the bag, kicks at 80% while the shins adapt. NO BAG YET: run it as shadow, chase snap and full retraction instead of impact, add one round per session, and treat Power as postponed rather than skipped.',
 d:{
  ...
  wed:{tm:{work:180,rest:60,rounds:3},
   ...
   r:[['R1 jab only','real contact, real snap'],['R2 body only','invest downstairs all round'],['R3 all hands 70%','light feet, you jumped this morning']]},
  thu:{tm:{work:180,rest:60,rounds:5},
...
{n:9,phase:'Phase 5 · Creation',theme:'Rhythm',note:'A readable rhythm is how you get hit. Fast, slow, pause, burst, on the bag now. Same strikes on a beat nobody can count. This is the week it starts being fun.',
 d:{
  ...
  thu:{tm:{work:180,rest:60,rounds:5},
   t:[['Rotate every 30 sec. 1:00 rest.'],['30s burst, reset, burst'],['30s push-ups'],['30s broken-rhythm shadow'],['30s mountain climbers'],['30s burst of six, then reset'],['30s free rhythm']],
   r:[['Finisher, 5 min'],['Plank 3 x 60 sec'],['Hollow hold 3 x 45 sec'],['Leg raises 3 x 25'],['Russian twists 3 x 50']]},
  fri:{tm:{work:180,rest:60,rounds:3},
...
{n:10,phase:'Phase 5 · Creation',theme:'Free',note:'No prescribed combos. Everything you built, unscripted, on the bag and in the air. Run the 5-point checkpoint Sunday, then book the trial class.',
 d:{
  ...
  thu:{tm:{work:180,rest:60,rounds:5},
   t:[['Rotate every 30 sec. 1:00 rest.'],['30s free max output'],['30s push-ups'],['30s free shadow'],['30s mountain climbers'],['30s free hands, max output'],['30s free, whatever comes']],
   r:[['Finisher, 5 min'],['Plank 3 x 60 sec'],['Hollow hold 3 x 45 sec'],['Leg raises 3 x 25'],['Russian twists 3 x 50']]},
  fri:{tm:{work:180,rest:60,rounds:3},
  ...
  sat:{tm:{work:180,rest:60,rounds:5},
   t:[['Rotate every 30 sec, hands only. 1:00 rest.'],['30s free max'],['30s push-up variations'],['30s free hands'],['30s free counters'],['30s free hands'],['30s fight sim pace']],
   r:[['Finisher, 3 min','one station only, the lift already gave you two'],['Bicycles 3 x 50']]},
  sun:{tm:null,
